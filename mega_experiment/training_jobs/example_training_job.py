...
from mega_experiment.training_jobs.training_job import TrainingJob, create_job_hyperparams_class, HyperparamOptions
import torch as t
...
class ExampleTrainingJob(TrainingJob):
    ...
    def model(self, hyperparams: Hyperparams) -> t.Module:
    ...
    def optimizer(self, hyperparams: Hyperparams, model: t.Module) -> t.optim.Optimizer:
